...
# optimizer_reg = torch.optim.Adam(list(encoder.parameters()) + list(regressor.parameters()), lr=1e-4)
#
...
#     print(f"Stage 2 Epoch {epoch+1}, Loss: {total_loss/len(train_ds):.4f}, MAE: {total_mae/(len(train_ds)*2):.4f}")
#
# # Save regressor
